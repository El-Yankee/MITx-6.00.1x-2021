...
def hangman(secretWord):
    ...
    * After each round, you should also display to the user the 
    ...
    while not((isWordGuessed(secretWord, lettersGuessed))) and number_guesses > 0:
        ...
        guesses += guessInLowerCase
        
        lettersGuessed = list(guesses)
        
        if guessInLowerCase in already_guess :
            ...
            already_guess += guessInLowerCase
